...
st.set_page_config(page_title="BeeCare 급여제공지침 교육일지 2", layout="centered")

st.title("BeeCare 급여제공지침 교육일지 생성기 2")
...
instructor = st.text_input("강사", placeholder="예: 시설장, 사회복지사, 간호사, 관리책임자")
